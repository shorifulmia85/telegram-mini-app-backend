...
`)]),[es,ql]=k("InvalidLaunchParamsError",(e,t)=>[`Invalid value for launch params: ${e}`,{cause:t}]),[ts,Il]=k("UnknownEnvError"),[ns,jl]=k("InvokeCustomMethodError",e=>[`Server returned error: ${e}`]),Te=ge((...e)=>{try{window.parent.postMessage(...e)}catch(t){t instanceof SyntaxError?x().forceError("Unable to call window.parent.postMessage due to incorrectly configured target origin. Use the setTargetOrigin method to allow this origin to receive events",t):x().forceError(t)}}),rs=(...e)=>Te()(...e),os=ge("https://web.telegram.org");function pn(e,t){x().log("Posting event:",t?{eventType:e,eventData:t}:{eventType:e});const n=window,o=JSON.stringify({eventType:e,eventData:t});if(zo())return rs(o,os());if(Wo(n)){n.TelegramWebviewProxy.postEvent(e,JSON.stringify(t));return}if(We(D({external:D({notify:Jt()})}),n)){n.external.notify(o);return}throw new ts}function dn(e,t,n){n||(n={});const{capture:o}=n,[s,i]=Ge();return new C(a=>{(Array.isArray(t)?t:[t]).forEach(c=>{s(w(c,u=>{(!o||(Array.isArray(t)?o({event:c,payload:u}):o(u)))&&a(u)}))}),(n.postEvent||pn)(e,n.params)},n).finally(i)}const ss="launchParams";function is(e){return e.replace(/^[^?#]*[?#]/,"").replace(/[?#]/g,"&")}function fn(){const e=[];for(const[t,n]of[[()=>is(window.location.href),"window.location.href"],[()=>{const o=performance.getEntriesByType("navigation")[0];return o&&is(o.name)},"performance navigation entries"],[()=>I(ss),"local storage"]]){const o=t();if(!o){e.push([n,new Error("Source is empty")]);continue}if(Ho(o))return N(ss,o),o;try{Je(o)}catch(s){e.push([n,s])}}throw new xo(e)}function Xe(e){const t=Je(fn());return e?Zt(t):t}function mn(e,t){if(!e)try{return Xe(),!0}catch{return!1}return C.fn(async n=>{if(Wo(window))return!0;try{return await dn("web_app_request_theme","theme_changed",n),!0}catch{return!1}},t||{timeout:100})}function Dl({launchParams:e,onEvent:t,resetPostMessage:n}={}){if(e){const i=typeof e=="string"||e instanceof URLSearchParams?e.toString():Ro({...e,tgWebAppData:void 0})+(e.tgWebAppData?`&tgWebAppData=${encodeURIComponent(e.tgWebAppData.toString())}`:"");if(!Ho(i))try{Je(i)}catch(a){throw new es(i,a)}N("launchParams",i)}if(zo()){if(!t)return;const i=_e($(),Ke(),Vo);n&&Te.reset();const a=Te();Te.set((...c)=>{const[u]=c,l=()=>{a(...c)};if(We(i,u)){const p=Y(i,u);t([p.eventType,p.eventData],l)}else l()});return}const o=window.TelegramWebviewProxy||{},s=o.postEvent||(()=>{});window.TelegramWebviewProxy={...o,postEvent(i,a){const c=()=>{s(i,a)};t?t([i,a?JSON.parse(a):void 0],c):c()}},x().log("Environment was mocked by the mockTelegramEnv function")}function as(){return new URLSearchParams(fn()).get("tgWebAppData")||void 0}function cs(e){return({req_id:t})=>t===e}function us(e){return e.split(".").map(Number)}function Nl(e,t){const n=us(e),o=us(t),s=Math.max(n.length,o.length);for(let i=0;i<s;i+=1){const a=n[i]||0,c=o[i]||0;if(a!==c)return a>c?1:-1}return 0}function A(e,t){return Nl(e,t)<=0}function ee(e,t,n){if(typeof n=="string"){if(e==="web_app_open_link"){if(t==="try_instant_view")return A("6.4",n);if(t==="try_browser")return A("7.6",n)}if(e==="web_app_set_header_color"&&t==="color")return A("6.9",n);if(e==="web_app_close"&&t==="return_back")return A("7.6",n);if(e==="web_app_setup_main_button"&&t==="has_shine_effect")return A("7.10",n)}switch(e){case"web_app_open_tg_link":case"web_app_open_invoice":case"web_app_setup_back_button":case"web_app_set_background_color":case"web_app_set_header_color":case"web_app_trigger_haptic_feedback":return A("6.1",t);case"web_app_open_popup":return A("6.2",t);case"web_app_close_scan_qr_popup":case"web_app_open_scan_qr_popup":case"web_app_read_text_from_clipboard":return A("6.4",t);case"web_app_switch_inline_query":return A("6.7",t);case"web_app_invoke_custom_method":case"web_app_request_write_access":case"web_app_request_phone":return A("6.9",t);case"web_app_setup_settings_button":return A("6.10",t);case"web_app_biometry_get_info":case"web_app_biometry_open_settings":case"web_app_biometry_request_access":case"web_app_biometry_request_auth":case"web_app_biometry_update_token":return A("7.2",t);case"web_app_setup_swipe_behavior":return A("7.7",t);case"web_app_share_to_story":return A("7.8",t);case"web_app_setup_secondary_button":case"web_app_set_bottom_bar_color":return A("7.10",t);case"web_app_request_safe_area":case"web_app_request_content_safe_area":case"web_app_request_fullscreen":case"web_app_exit_fullscreen":case"web_app_set_emoji_status":case"web_app_add_to_home_screen":case"web_app_check_home_screen":case"web_app_request_emoji_status_access":case"web_app_check_location":case"web_app_open_location_settings":case"web_app_request_file_download":case"web_app_request_location":case"web_app_send_prepared_message":case"web_app_start_accelerometer":case"web_app_start_device_orientation":case"web_app_start_gyroscope":case"web_app_stop_accelerometer":case"web_app_stop_device_orientation":case"web_app_stop_gyroscope":case"web_app_toggle_orientation_lock":return A("8.0",t);case"web_app_device_storage_clear":case"web_app_device_storage_get_key":case"web_app_device_storage_save_key":case"web_app_secure_storage_clear":case"web_app_secure_storage_get_key":case"web_app_secure_storage_restore_key":case"web_app_secure_storage_save_key":return A("9.0",t);case"web_app_hide_keyboard":return A("9.1",t);default:return["iframe_ready","iframe_will_reload","web_app_close","web_app_data_send","web_app_expand","web_app_open_link","web_app_ready","web_app_request_theme","web_app_request_viewport","web_app_setup_main_button","web_app_setup_closing_behavior"].includes(e)}}function ls(e,t){t||(t="strict");const n=typeof t=="function"?t:o=>{const{method:s,version:i}=o,a="param"in o?new Xo(s,o.param,i):new Zo(s,i);if(t==="strict")throw a;return x().forceWarn(a.message)};return(o,s)=>ee(o,e)?o==="web_app_set_header_color"&&We(D({color:Xr()}),s)&&!ee(o,"color",e)?n({version:e,method:o,param:"color"}):pn(o,s):n({version:e,method:o})}function Vl(e){const t=un(typeof e=="string"?e:JSON.stringify(e));if(t.length>512)throw new Error("Value is too long for start parameter");return t}function Ll(e,t){const n=Uo(e);return t==="json"?JSON.parse(n):t?t(n):n}function Rl(e){return un(e).length<=512}function Hl(e,t,n,o){return dn("web_app_invoke_custom_method","custom_method_invoked",{...o||{},params:{method:e,params:t,req_id:n},capture:cs(n)}).then(({result:s,error:i})=>{if(i)throw new ns(i);return s})}function Fl(){Object.hasOwn||(Object.hasOwn=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)})}function Ul(){return performance.getEntriesByType("navigation")[0]}function L(){const e=Ul();return!!e&&e.type==="reload"}function ye(e,t){return ge(e,t)}function m(e,t){return El(e,t)}function b(e,t){const n=ye(e,t);return[n,m(n)]}let ps=!1;function Wl(e){ps=e,Ml(e)}const xe=ge(Xt("Bridge",{bgColor:"forestgreen",textColor:"white",shouldLog(){return ps}})),_n=ye(0),ds=ye(pn),[fs,Be]=b({tgWebAppPlatform:"unknown",tgWebAppVersion:"0.0"}),te=m(()=>Be().tgWebAppVersion);function ms(e){e||(e={});const{postEvent:t}=e,n=e.launchParams||Xe();fs.set(n),ds.set(typeof t=="function"?t:ls(n.tgWebAppVersion)),xe().log("The package was configured. Launch params:",fs())}function hn(){return _n.set(_n()+1),_n().toString()}function ie(e,t,n){return Hl(e,t,hn(),{...n||{},postEvent:f})}const S=(e,t,n)=>(n||(n={}),n.postEvent||(n.postEvent=f),dn(e,t,n)),f=(e,t)=>ds()(e,t);function F(e){return m(()=>ee(e,te()))}function ae(e){return[e]}const[et,zl]=k("CSSVarsBoundError","CSS variables are already bound"),[bn,Gl]=k("NotAvailableError",ae),[Ql,Kl]=k("InvalidEnvError",ae),[ve,Jl]=k("FunctionNotAvailableError",ae),[U,Yl]=k("InvalidArgumentsError",(e,t)=>[e,{cause:t}]),[_s,Zl]=k("ConcurrentCallError",ae),[hs,Xl]=k("SetEmojiStatusError",e=>[`Failed to set emoji status: ${e}`]),[gn,xl]=k("AccessDeniedError",ae),[bs,ep]=k("FullscreenFailedError",ae),[gs,tp]=k("ShareMessageError",ae),[tt,np]=k("UnknownThemeParamsKeyError",e=>[`Unknown theme params key passed: ${e}`]);function yn(){return typeof window>"u"}function E(e,t,n){n||(n={});const{isSupported:o,isMounted:s,isMounting:i,component:a,supports:c}=n||{},u=`${a?`${a}.`:""}${e}()`,l=o?Array.isArray(o)||typeof o=="object"&&"any"in o?o:[o]:void 0;function p(P){if(c){const M=c[P];return ee(M[0],M[1],te())}return!0}function d(){if(!l)return;function P(J){return typeof J=="function"?J():ee(J,te())?void 0:`it is unsupported in Mini Apps version ${te()}`}const M=Array.isArray(l)?l:l.any,G=M.map(P).filter(Boolean);return Array.isArray(l)?G[0]:G.length===M.length?G[G.length-1]:void 0}function g(...P){for(const M in c)if(c[M][2](...P)&&!p(M))return`option ${M} is not supported in Mini Apps version ${te()}`}let _;if(c){_={};for(const P in c)_[P]=m(()=>p(P))}const W=m(()=>!d()),Lt=m(()=>te()!=="0.0"),K=m(()=>!s||s()),Ue=m(()=>mn()&&!yn()&&Lt()&&W()&&K());return Object.assign((...P)=>{const M=`Unable to call the ${u} ${a?"method":"function"}:`;if(yn()||!mn())throw new ve(`${M} it can't be called outside Mini Apps`);if(!Lt())throw new ve(`${M} the SDK was not initialized. Use the SDK init() function`);const G=d();if(G)throw new ve(`${M} ${G}`);const J=g(...P);if(J)throw new ve(`${M} ${J}`);if(!K()){const h=i&&i()?"mounting. Wait for the mount completion":`unmounted. Use the ${a}.mount() method`;throw new ve(`${M} the component is ${h}`)}return t(...P)},t,{isAvailable:Ue,ifAvailable(...P){return Ue()?[!0,t(...P)]:[!1]}},l?{isSupported:W}:{},_?{supports:_}:{})}function nt(e,t){return t||(t={}),(n,o,s,i)=>E(n,o,{...t,isSupported:s||t.isSupported,supports:i,component:e})}function ne(e,t,n){return nt(e,{isSupported:n,isMounted:t})}function R(e,t){return nt(e,{isSupported:t})}const rt="web_app_setup_back_button",ys="back_button_pressed",ot="backButton",[vs,ws]=b(!1),[st,Es]=b(!1),Ss=F(rt),$s=ne(ot,st,rt),vn=R(ot,rt),Cs=$s("hide",()=>{wn(!1)}),As=vn("mount",()=>{st()||(wn(L()&&I(ot)||!1),st.set(!0))});function wn(e){e!==vs()&&(f(rt,{is_visible:e}),N(ot,e),vs.set(e))}const Ms=vn("onClick",e=>w(ys,e)),ks=vn("offClick",e=>{B(ys,e)}),Ps=$s("show",()=>{wn(!0)});function Ts(){st.set(!1)}const rp=Object.freeze(Object.defineProperty({__proto__:null,hide:Cs,isMounted:Es,isSupported:Ss,isVisible:ws,mount:As,offClick:ks,onClick:Ms,show:Ps,unmount:Ts},Symbol.toStringTag,{value:"Module"}));function j(e,t,n){n||(n={});const{promise:o,error:s}=n,[i,a]=o?[o,m(o)]:b(),[c,u]=s?[s,m(s)]:b();return[Object.assign((...l)=>{if(i()){const d=new _s(t);return c.set(d),C.reject(d)}ke(()=>{i.set(e(...l)),c.set(void 0)});let p;return i().catch(d=>{throw p=d,d}).finally(()=>{ke(()=>{i.set(void 0),c.set(p)})})},e),[i,a,m(()=>!!i())],[c,u]]}function Oe(e,t,n){const[o,...s]=j(t,`The ${e} component is already mounting`),[i,a]=b(!1);return[(...c)=>i()?C.resolve():o(...c).then(u=>{ke(()=>{i.set(!0),n(u)})}),...s,[i,a]]}const[En,Bs]=b({available:!1,type:"",accessGranted:!1,accessRequested:!1,deviceId:"",tokenSaved:!1}),Os=m(()=>En().available),qs="web_app_biometry_get_info",Is=E("requestBiometry",e=>S(qs,"biometry_info_received",e),{isSupported:qs});function Sn(e){if(!ao(e))throw e}function we(e){const t=e();t&&t.catch(Sn).cancel()}const qe="biometry",it="web_app_biometry_request_auth",$n="biometry_info_received",js=e=>{at(Cn(e))};function Ds(){throw new bn("Biometry is not available")}function Cn(e){let t=!1,n=!1,o="",s=!1,i="",a=!1;return e.available&&(t=!0,n=e.token_saved,o=e.device_id,s=e.access_requested,i=e.type,a=e.access_granted),{available:t,tokenSaved:n,deviceId:o,type:i,accessGranted:a,accessRequested:s}}const Ns=F(it),[op,sp,ip,Vs]=Oe(qe,e=>{const t=L()&&I(qe);return t?C.resolve(t):Is({abortSignal:e}).then(Cn)},e=>{w($n,js),at(e)}),Ls=R(qe,it),An=ne(qe,Vs[0],it),Rs=Ls("mount",op),[,Mn,Hs]=sp,[,Fs]=ip,[ap,Us]=Vs,[cp,up,lp]=j(e=>C.fn(async t=>{const n=En();n.available||Ds();const o=await S(it,"biometry_auth_requested",{...e,...t,params:{reason:((e||{}).reason||"").trim()}}),{token:s}=o;return typeof s=="string"&&at({...n,token:s}),o},e),"Biometry authentication is already in progress"),Ws=An("authenticate",cp),[,kn,zs]=up,[,Gs]=lp,Qs=Ls("openSettings",()=>{f("web_app_biometry_open_settings")}),[pp,dp,fp]=j(e=>C.fn(async t=>{const n=await S("web_app_biometry_request_access",$n,{...e,...t,params:{reason:(e||{}).reason||""}}).then(Cn);return n.available||Ds(),at(n),n.accessGranted},e),"Biometry access request is already in progress"),Ks=An("requestAccess",pp),[,Pn,Js]=dp,[,Ys]=fp;function at(e){En.set(e),N(qe,e)}function Zs(){[kn,Pn,Mn].forEach(we),B($n,js),ap.set(!1)}const Xs=An("updateToken",e=>(e||(e={}),S("web_app_biometry_update_token","biometry_token_updated",{...e,params:{token:e.token||"",reason:e.reason}}).then(t=>t.status))),mp=Object.freeze(Object.defineProperty({__proto__:null,authError:Gs,authPromise:kn,authenticate:Ws,isAuthenticating:zs,isAvailable:Os,isMounted:Us,isMounting:Hs,isRequestingAccess:Js,isSupported:Ns,mount:Rs,mountError:Fs,mountPromise:Mn,openSettings:Qs,requestAccess:Ks,requestAccessError:Ys,requestAccessPromise:Pn,state:Bs,unmount:Zs,updateToken:Xs},Symbol.toStringTag,{value:"Module"}));function ct(e,t){return nt(e,{isMounted:t})}const re=nt,ut="closingBehavior",[xs,ei]=b(!1),[Tn,Bn]=b(!1),ti=ct(ut,Bn),_p=re(ut),ni=ti("disableConfirmation",()=>{On(!1)}),ri=ti("enableConfirmation",()=>{On(!0)}),oi=_p("mount",()=>{Tn()||(On(L()&&I(ut)||!1),Tn.set(!0))});function On(e){e!==xs()&&(f("web_app_setup_closing_behavior",{need_confirmation:e}),N(ut,e),xs.set(e))}function si(){Tn.set(!1)}const hp=Object.freeze(Object.defineProperty({__proto__:null,disableConfirmation:ni,enableConfirmation:ri,isConfirmationEnabled:ei,isMounted:Bn,mount:oi,unmount:si},Symbol.toStringTag,{value:"Module"})),ii="web_app_invoke_custom_method",Ie=R("cloudStorage",ii),ai=F(ii),qn=Ie("deleteItem",(e,t)=>{const n=Array.isArray(e)?e:[e];return n.length?ie("deleteStorageValues",{keys:n},t).then():C.resolve()});function bp(e,t){const n=Array.isArray(e)?e:[e];return n.length?ie("getStorageValues",{keys:n},t).then(o=>{const s={...n.reduce((i,a)=>(i[a]="",i),{}),...Y(to($(),$()),o)};return typeof e=="string"?s[e]:s}):C.resolve(Array.isArray(e)?{}:"")}const ci=Ie("getItem",bp),In=Ie("getKeys",e=>ie("getStorageKeys",{},e).then(t=>Y(xr($()),t))),ui=Ie("setItem",(e,t,n)=>ie("saveStorageValue",{key:e,value:t},n).then()),gp=Ie("clear",e=>In(e).then(qn)),yp=Object.freeze(Object.defineProperty({__proto__:null,clear:gp,deleteItem:qn,getItem:ci,getKeys:In,isSupported:ai,setItem:ui},Symbol.toStringTag,{value:"Module"})),je="web_app_trigger_haptic_feedback",jn=R("hapticFeedback",je),li=F(je),pi=jn("impactOccurred",e=>{f(je,{type:"impact",impact_style:e})}),di=jn("notificationOccurred",e=>{f(je,{type:"notification",notification_type:e})}),fi=jn("selectionChanged",()=>{f(je,{type:"selection_change"})}),vp=Object.freeze(Object.defineProperty({__proto__:null,impactOccurred:pi,isSupported:li,notificationOccurred:di,selectionChanged:fi},Symbol.toStringTag,{value:"Module"})),[mi,_i]=b(void 0);function z(e){return m(()=>{const t=mi();return t?t[e]:void 0})}const Dn=z("auth_date"),Nn=z("can_send_after"),hi=m(()=>{const e=Dn(),t=Nn();return t&&e?new Date(e.getTime()+t*1e3):void 0}),bi=z("chat"),gi=z("chat_type"),yi=z("chat_instance"),vi=z("hash"),wi=z("query_id"),[wp,Ei]=b(),Si=z("receiver");function $i(){const e=Xe();mi.set(e.tgWebAppData),wp.set(as())}const Ci=z("start_param"),Ai=z("user"),Ep=Object.freeze(Object.defineProperty({__proto__:null,authDate:Dn,canSendAfter:Nn,canSendAfterDate:hi,chat:bi,chatInstance:yi,chatType:gi,hash:vi,queryId:wi,raw:Ei,receiver:Si,restore:$i,startParam:Ci,state:_i,user:Ai},Symbol.toStringTag,{value:"Module"})),Vn="web_app_open_invoice",Sp=R("invoice",Vn),Mi=F(Vn);function $p(e,t,n){let o;if(t==="url"){const{hostname:s,pathname:i}=new URL(e,window.location.href);if(s!=="t.me")throw new U(`Link has unexpected hostname: ${s}`);const a=i.match(/^\/(\$|invoice\/)([A-Za-z0-9\-_=]+)$/);if(!a)throw new U('Expected to receive a link with a pathname in format "/invoice/{slug}" or "/${slug}"');[,,o]=a}else o=e,n=t;return S(Vn,"invoice_closed",{...n,params:{slug:o},capture:s=>o===s.slug}).then(s=>s.status)}const[Cp,Ap,Mp]=j($p,"Invoice is already opened"),ki=Sp("open",Cp),[,Pi,Ti]=Ap,[,Bi]=Mp,kp=Object.freeze(Object.defineProperty({__proto__:null,isOpened:Ti,isSupported:Mi,open:ki,openError:Bi,openPromise:Pi},Symbol.toStringTag,{value:"Module"})),De="locationManager",Ln="web_app_check_location",Oi="web_app_open_location_settings",lt=ye({available:!1,accessGranted:!1,accessRequested:!1});function Rn(e){return m(()=>lt()[e])}const qi=F(Ln),Ii=Rn("available"),ji=Rn("accessGranted"),Di=Rn("accessRequested");function Pp(e){let t=!1,n,o;return e.available&&(t=!0,n=e.access_requested,o=e.access_granted),{available:t,accessGranted:o||!1,accessRequested:n||!1}}const[Tp,Bp,Op,Ni]=Oe(De,e=>{const t=L()&&I(De);return t?C.resolve(t):S("web_app_check_location","location_checked",e).then(Pp)},e=>{lt.set(e),N(De,e)}),Vi=R(De,Ln),qp=ne(De,Ni[0],Ln),Li=Vi("mount",Tp),[,Ri,Hi]=Bp,[,Fi]=Op,[Ip,Ui]=Ni,[jp,Dp,Np]=j(e=>S("web_app_request_location","location_requested",e).then(t=>{if(!t.available)throw lt.set({...lt(),available:!1}),new bn("Location data tracking is not available");const{available:n,...o}=t;return o}),"Location request is currently in progress"),Wi=qp("requestLocation",jp),[,Hn,zi]=Dp,[,Gi]=Np,Qi=Vi("openSettings",()=>{f(Oi)},Oi);function Ki(){we(Hn),Ip.set(!1)}const Vp=Object.freeze(Object.defineProperty({__proto__:null,isAccessGranted:ji,isAccessRequested:Di,isAvailable:Ii,isMounted:Ui,isMounting:Hi,isRequestingLocation:zi,isSupported:qi,mount:Li,mountError:Fi,mountPromise:Ri,openSettings:Qi,requestLocation:Wi,requestLocationError:Gi,requestLocationPromise:Hn,unmount:Ki},Symbol.toStringTag,{value:"Module"}));function Fn(e){const t={};for(const n in e){const o=e[n];o!==void 0&&(t[n]=o)}return t}function Un(e){const t=Io(e);return Math.sqrt([.299,.587,.114].reduce((n,o,s)=>{const i=parseInt(t.slice(1+s*2,1+(s+1)*2),16);return n+i*i*o},0))<120}const[Wn,Ji]=b(!1),[ce,ue]=b({});function O(e){return m(()=>ce()[e])}const Yi=O("accent_text_color"),zn=O("bg_color"),pt=O("button_color"),Gn=O("button_text_color"),Zi=O("bottom_bar_bg_color"),Xi=O("destructive_text_color"),xi=O("header_bg_color"),ea=O("hint_color"),ta=m(()=>{const e=zn();return!e||Un(e)}),na=O("link_color"),Qn=O("secondary_bg_color"),ra=O("section_bg_color"),oa=O("section_header_text_color"),sa=O("section_separator_color"),ia=O("subtitle_text_color"),aa=O("text_color");function le(e){return m(()=>dt()[e])}const Ne=ye({hasShineEffect:!1,isEnabled:!0,isLoaderVisible:!1,isVisible:!1,text:"Continue"}),dt=m(()=>{const e=Ne();return{...e,backgroundColor:e.backgroundColor||pt()||"#2481cc",textColor:e.textColor||Gn()||"#ffffff"}}),[Kn,Jn]=b(!1),ca=le("backgroundColor"),ua=le("hasShineEffect"),la=le("isEnabled"),pa=le("isLoaderVisible"),da=le("isVisible"),fa=le("text"),ma=le("textColor"),Lp="web_app_setup_main_button",_a="main_button_pressed",ft="mainButton",Yn=re(ft),Rp=ct(ft,Jn),ha=Yn("mount",()=>{if(!Kn()){const e=L()&&I(ft);e&&Ne.set(e),Kn.set(!0)}}),ba=Yn("onClick",e=>w(_a,e)),ga=Yn("offClick",e=>{B(_a,e)}),ya=Rp("setParams",e=>{Ne.set({...Ne(),...Fn(e)}),N(ft,Ne());const t=dt();t.text&&f(Lp,{color:t.backgroundColor,has_shine_effect:t.hasShineEffect,is_active:t.isEnabled,is_progress_visible:t.isLoaderVisible,is_visible:t.isVisible,text:t.text,text_color:t.textColor})});function va(){Kn.set(!1)}const Hp=Object.freeze(Object.defineProperty({__proto__:null,backgroundColor:ca,hasShineEffect:ua,isEnabled:la,isLoaderVisible:pa,isMounted:Jn,isVisible:da,mount:ha,offClick:ga,onClick:ba,setParams:ya,state:dt,text:fa,textColor:ma,unmount:va},Symbol.toStringTag,{value:"Module"}));function Zn(e,t){document.documentElement.style.setProperty(e,t)}function Xn(e){document.documentElement.style.removeProperty(e)}const Ee="themeParams",xn="theme_changed",wa=re(Ee),er=({theme_params:e})=>{ce.set(e),N(Ee,e)},[Fp,Ea,Up,Sa]=Oe(Ee,e=>C.resolve(L()&&I(Ee)||Be().tgWebAppThemeParams||{}),e=>{w(xn,er),ce.set(e)}),$a=ct(Ee,Sa[0])("bindCssVars",e=>{if(Wn())throw new et;e||(e=o=>`--tg-theme-${ol(o)}`);function t(o){Object.entries(ce()).forEach(([s,i])=>{i&&o(s,i)})}function n(){t((o,s)=>{Zn(e(o),s)})}return n(),ce.sub(n),Wn.set(!0),()=>{t(Xn),ce.unsub(n),Wn.set(!1)}}),tr=wa("mount",Fp),Ca=Ea[2],nr=Ea[1],Aa=Up[1],[rr,Ma]=Sa,or=wa("mountSync",()=>{if(!rr()){const e=L()&&I(Ee)||Be().tgWebAppThemeParams||{};w(xn,er),ke(()=>{ce.set(e),rr.set(!0)})}});function ka(){we(nr),B(xn,er),rr.set(!1)}function Pa(e){return m(()=>mt(e()))}function mt(e){return se(e)?e:ue()[e]}const[Ve,Ta]=b("bg_color"),_t=Pa(Ve),[Le,Ba]=b("bottom_bar_bg_color"),ht=m(()=>{const e=Le();return se(e)?e:ue()[e]||Qn()}),[Re,Oa]=b("bg_color"),sr=Pa(Re),[ir,qa]=b(!1),Ia=m(()=>{const e=_t();return e?Un(e):!1}),[bt,ja]=b(!0),ar=m(()=>({backgroundColor:Ve(),bottomBarColor:Le(),headerColor:Re(),isActive:bt()})),Wp=Object.freeze(Object.defineProperty({__proto__:null,accentTextColor:Yi,backgroundColor:zn,bindCssVars:$a,bottomBarBgColor:Zi,buttonColor:pt,buttonTextColor:Gn,destructiveTextColor:Xi,headerBackgroundColor:xi,hintColor:ea,isCssVarsBound:Ji,isDark:ta,isMounted:Ma,isMounting:Ca,linkColor:na,mount:tr,mountError:Aa,mountPromise:nr,mountSync:or,secondaryBackgroundColor:Qn,sectionBackgroundColor:ra,sectionHeaderTextColor:oa,sectionSeparatorColor:sa,state:ue,subtitleTextColor:ia,textColor:aa,unmount:ka},Symbol.toStringTag,{value:"Module"})),gt="web_app_set_background_color",yt="web_app_set_bottom_bar_color",pe="web_app_set_header_color",cr="visibility_changed",de="miniApp",ur={any:[gt,yt,pe]},Da=m(()=>ur.any.some(e=>ee(e,te()))),lr=e=>{bt.set(e.is_visible),wt()},pr=e=>{[[Re,pe],[Ve,gt],[Le,yt]].forEach(([t,n])=>{const o=t();if(!se(o)&&(n!==pe||o!=="bg_color"&&o!=="secondary_bg_color")){const s=e[o];s&&f(n,{color:s})}})},[zp,Na,Gp,Va]=Oe(de,e=>tr(e).then(()=>L()&&I(de)||void 0),e=>{Et.ifAvailable(e?e.backgroundColor:"bg_color"),St.ifAvailable(e?e.bottomBarColor:"bottom_bar_bg_color"),$t.ifAvailable(e?e.headerColor:"bg_color"),bt.set(e?e.isActive:!0),w(cr,lr),ue.sub(pr)}),La=re(de),Ra=R(de,ur),vt=ne(de,Va[0],ur),Ha=vt("bindCssVars",e=>{if(ir())throw new et;const[t,n]=Ge();function o(s,i){function a(){Zn(s,i()||null)}a(),t(i.sub(a),Xn.bind(null,s))}return e||(e=s=>`--tg-${_o(s)}`),o(e("bgColor"),_t),o(e("bottomBarColor"),ht),o(e("headerColor"),sr),t(()=>{ir.set(!1)}),ir.set(!0),n}),Fa=La("close",e=>{f("web_app_close",{return_back:e})}),Ua=Ra("mount",zp),Wa=Na[2],dr=Na[1],za=Gp[1],[fr,Ga]=Va,Qa=Ra("mountSync",()=>{if(!fr()){or();const e=L()&&I(de)||void 0;Et.ifAvailable(e?e.backgroundColor:"bg_color"),St.ifAvailable(e?e.bottomBarColor:"bottom_bar_bg_color"),$t.ifAvailable(e?e.headerColor:"bg_color"),w(cr,lr),ue.sub(pr),ke(()=>{bt.set(e?e.isActive:!0),fr.set(!0)})}}),Ka=La("ready",()=>{f("web_app_ready")});function wt(){N(de,ar())}const Et=vt("setBackgroundColor",e=>{if(e===Ve())return;const t=mt(e);if(!t)throw new tt(e);f(gt,{color:t}),Ve.set(e),wt()},gt),St=vt("setBottomBarColor",e=>{if(e===Le())return;const t=mt(e);if(!t)throw new tt(e);f(yt,{color:t}),Le.set(e),wt()},yt),$t=vt("setHeaderColor",e=>{if(e!==Re()){if(e==="bg_color"||e==="secondary_bg_color")f(pe,{color_key:e});else{const t=mt(e);if(!t)throw new tt(e);f(pe,{color:t})}Re.set(e),wt()}},pe,{rgb:[pe,"color",se]});function Ja(){we(dr),B(cr,lr),ue.unsub(pr),fr.set(!1)}const Qp=Object.freeze(Object.defineProperty({__proto__:null,backgroundColor:Ta,backgroundColorRGB:_t,bindCssVars:Ha,bottomBarColor:Ba,bottomBarColorRGB:ht,close:Fa,headerColor:Oa,headerColorRGB:sr,isActive:ja,isCssVarsBound:qa,isDark:Ia,isMounted:Ga,isMounting:Wa,isSupported:Da,mount:Ua,mountError:za,mountPromise:dr,mountSync:Qa,ready:Ka,setBackgroundColor:Et,setBottomBarColor:St,setHeaderColor:$t,state:ar,unmount:Ja},Symbol.toStringTag,{value:"Module"}));function Kp(e){const t=e.message.trim(),n=(e.title||"").trim(),o=e.buttons||[];if(n.length>64)throw new U(`Invalid title: ${n}`);if(!t||t.length>256)throw new U(`Invalid message: ${t}`);if(o.length>3)throw new U(`Invalid buttons count: ${o.length}`);return{title:n,message:t,buttons:o.length?o.map((s,i)=>{const a=s.id||"";if(a.length>64)throw new U(`Button with index ${i} has invalid id: ${a}`);if(!s.type||s.type==="default"||s.type==="destructive"){const c=s.text.trim();if(!c||c.length>64)throw new U(`Button with index ${i} has invalid text: ${c}`);return{type:s.type,text:c,id:a}}return{type:s.type,id:a}}):[{type:"close",id:""}]}}const mr="web_app_open_popup",Ya=R("popup",mr),Za=F(mr),[Xa,_r,xa]=j(e=>S(mr,"popup_closed",{...e,params:Kp(e)}).then(({button_id:t})=>t===void 0?null:t),"A popup is already opened"),ec=Ya("open",Xa),tc=_r[1],nc=_r[2],rc=xa[1],oc=Ya("show",Xa),[,sc,ic]=_r,[,ac]=xa,Jp=Object.freeze(Object.defineProperty({__proto__:null,isOpened:nc,isShown:ic,isSupported:Za,open:ec,openError:rc,openPromise:tc,show:oc,showError:ac,showPromise:sc},Symbol.toStringTag,{value:"Module"})),cc="web_app_close_scan_qr_popup",hr="web_app_open_scan_qr_popup",Yp="scan_qr_popup_closed",Zp="qr_text_received",uc=R("qrScanner",hr),lc=uc("close",()=>{f(cc),we(br)}),pc=F(hr);function Xp(e){e||(e={});const{onCaptured:t,text:n,capture:o}=e,[,s]=Ge(w(Yp,()=>{i.resolve()}),w(Zp,a=>{t?t(a.data):(!o||o(a.data))&&(i.resolve(a.data),f(cc))})),i=new mo(e);return(e.postEvent||f)(hr,{text:n}),C.resolve(i).catch(Sn).finally(s)}const[xp,ed,td]=j(Xp,"The QR Scanner is already opened"),dc=uc("open",xp),[,br,fc]=ed,[,mc]=td,nd=Object.freeze(Object.defineProperty({__proto__:null,close:lc,isOpened:fc,isSupported:pc,open:dc,openError:mc,openPromise:br},Symbol.toStringTag,{value:"Module"}));function oe(e){return m(()=>Ct()[e])}const He=ye({hasShineEffect:!1,isEnabled:!0,isLoaderVisible:!1,isVisible:!1,position:"left",text:"Cancel"}),Ct=m(()=>{const e=He();return{...e,backgroundColor:e.backgroundColor||ht()||"#000000",textColor:e.textColor||pt()||"#2481cc"}}),[gr,yr]=b(!1),_c=oe("backgroundColor"),hc=oe("hasShineEffect"),bc=oe("isEnabled"),gc=oe("isLoaderVisible"),yc=oe("isVisible"),vc=oe("position"),wc=oe("text"),Ec=oe("textColor"),At="web_app_setup_secondary_button",Sc="secondary_button_pressed",Mt="secondaryButton",vr=R(Mt,At),rd=ne(Mt,yr,At),$c=F(At),Cc=vr("mount",()=>{if(!gr()){const e=L()&&I(Mt);e&&He.set(e),gr.set(!0)}}),Ac=vr("onClick",e=>w(Sc,e)),Mc=vr("offClick",e=>{B(Sc,e)}),kc=rd("setParams",e=>{He.set({...He(),...Fn(e)}),N(Mt,He());const t=Ct();t.text&&f(At,{color:t.backgroundColor,has_shine_effect:t.hasShineEffect,is_active:t.isEnabled,is_progress_visible:t.isLoaderVisible,is_visible:t.isVisible,position:t.position,text:t.text,text_color:t.textColor})});function Pc(){gr.set(!1)}const od=Object.freeze(Object.defineProperty({__proto__:null,backgroundColor:_c,hasShineEffect:hc,isEnabled:bc,isLoaderVisible:gc,isMounted:yr,isSupported:$c,isVisible:yc,mount:Cc,offClick:Mc,onClick:Ac,position:vc,setParams:kc,state:Ct,text:wc,textColor:Ec,unmount:Pc},Symbol.toStringTag,{value:"Module"})),kt="web_app_setup_settings_button",Tc="settings_button_pressed",Pt="settingsButton",[Bc,Oc]=b(!1),[Tt,qc]=b(!1),Ic=F(kt),wr=R(Pt,kt),jc=ne(Pt,Tt,kt),Dc=jc("hide",()=>{Er(!1)}),Nc=wr("mount",()=>{Tt()||(Er(L()&&I(Pt)||!1),Tt.set(!0))});function Er(e){e!==Bc()&&(f(kt,{is_visible:e}),N(Pt,e),Bc.set(e))}const Vc=wr("onClick",e=>w(Tc,e)),Lc=wr("offClick",e=>{B(Tc,e)}),Rc=jc("show",()=>{Er(!0)});function Hc(){Tt.set(!1)}const sd=Object.freeze(Object.defineProperty({__proto__:null,hide:Dc,isMounted:qc,isSupported:Ic,isVisible:Oc,mount:Nc,offClick:Lc,onClick:Vc,show:Rc,unmount:Hc},Symbol.toStringTag,{value:"Module"})),Bt="web_app_setup_swipe_behavior",Ot="swipeBehavior",[Fe,Fc]=b(!1),Uc=F(Bt),[Sr,Wc]=b(!0),id=R(Ot,Bt),zc=ne(Ot,Fe,Bt),Gc=zc("disableVertical",()=>{$r(!1)}),Qc=zc("enableVertical",()=>{$r(!0)}),Kc=id("mount",()=>{Fe()||($r(L()&&I(Ot)||!1,!0),Fe.set(!0))});function $r(e,t){(e!==Sr()||t)&&(f(Bt,{allow_vertical_swipe:e}),N(Ot,e),Sr.set(e))}function Jc(){Fe.set(!1)}const ad=Object.freeze(Object.defineProperty({__proto__:null,_isMounted:Fe,_isVerticalEnabled:Sr,disableVertical:Gc,enableVertical:Qc,isMounted:Fc,isSupported:Uc,isVerticalEnabled:Wc,mount:Kc,unmount:Jc},Symbol.toStringTag,{value:"Module"})),fe="viewport",Cr="fullscreen_changed",Ar="safe_area_changed",Mr="content_safe_area_changed",kr="viewport_changed",Yc=re(fe),Zc={left:0,top:0,bottom:0,right:0};function Pr(e){return Math.max(e,0)}const[Tr,Br]=b({contentSafeAreaInsets:Zc,height:0,isExpanded:!1,isFullscreen:!1,safeAreaInsets:Zc,stableHeight:0,width:0});function me(e){return m(()=>Br()[e])}const qt=me("height"),It=me("stableHeight"),Or=me("width"),Xc=me("isExpanded"),xc=m(()=>qt()===It());function Se(e){const{height:t,stableHeight:n,width:o}=e;Tr.set({...Tr(),...Fn({...e,height:t?Pr(t):void 0,width:o?Pr(o):void 0,stableHeight:n?Pr(n):void 0})}),N(fe,Tr())}function cd(){return I(fe)}function jt(e){return m(()=>Dt()[e])}const Dt=me("contentSafeAreaInsets"),qr=jt("bottom"),Ir=jt("left"),jr=jt("right"),Dr=jt("top");function Nt(e){return m(()=>Vt()[e])}const Vt=me("safeAreaInsets"),Nr=Nt("bottom"),Vr=Nt("left"),Lr=Nt("right"),Rr=Nt("top"),eu="web_app_request_safe_area",tu=R(fe,eu),Hr=tu("requestContentSafeAreaInsets",e=>S("web_app_request_content_safe_area",Mr,e));function nu(e){return S("web_app_request_viewport",kr,e)}const Fr=tu("requestSafeAreaInsets",e=>S(eu,Ar,e)),ru=e=>{const{height:t}=e;Se({isExpanded:e.is_expanded,height:t,width:e.width,stableHeight:e.is_state_stable?t:void 0})},ou=e=>{Se({isFullscreen:e.is_fullscreen})},su=e=>{Se({safeAreaInsets:e})},iu=e=>{Se({contentSafeAreaInsets:e})},[ud,ld,pd,dd]=Oe(fe,e=>{const t=L()&&cd();return t?C.resolve(t):C.fn(async n=>{const o=await C.all([Fr.isAvailable()?Fr(n):Vt(),Hr.isAvailable()?Hr(n):Dt()]),s=Be(),i={contentSafeAreaInsets:o[1],isFullscreen:!!s.tgWebAppFullscreen,safeAreaInsets:o[0]};if(["macos","tdesktop","unigram","webk","weba","web"].includes(s.tgWebAppPlatform)){const a=window;return{...i,height:a.innerHeight,isExpanded:!0,stableHeight:a.innerHeight,width:a.innerWidth}}return nu(n).then(a=>({...i,height:a.height,isExpanded:a.is_expanded,stableHeight:a.is_state_stable?a.height:0,width:a.width}))},e)},e=>{w(kr,ru),w(Cr,ou),w(Ar,su),w(Mr,iu),Se(e)}),au=Yc("mount",ud),[,Ur,cu]=ld,[,uu]=pd,[Wr,lu]=dd;function pu(){we(Ur),B(kr,ru),B(Cr,ou),B(Ar,su),B(Mr,iu),Wr.set(!1)}const fd=ct(fe,Wr),[zr,du]=b(!1),fu=fd("bindCssVars",e=>{if(zr())throw new et;e||(e=n=>`--tg-viewport-${_o(n)}`);const t=[["height",qt],["stableHeight",It],["width",Or],["safeAreaInsetTop",Rr],["safeAreaInsetBottom",Nr],["safeAreaInsetLeft",Vr],["safeAreaInsetRight",Lr],["contentSafeAreaInsetTop",Dr],["contentSafeAreaInsetBottom",qr],["contentSafeAreaInsetLeft",Ir],["contentSafeAreaInsetRight",jr]].reduce((n,[o,s])=>{const i=e(o);if(i){const a=()=>{Zn(i,`${s()}px`)};n.push([a,s.sub(a),i])}return n},[]);return t.forEach(n=>{n[0]()}),zr.set(!0),()=>{t.forEach(n=>{n[1](),Xn(n[2])}),zr.set(!1)}}),mu=Yc("expand",()=>{f("web_app_expand")}),_u="web_app_request_fullscreen",md=ne(fe,Wr,_u),Gr=me("isFullscreen"),[_d,hu]=b(),[hd,bu]=b();function gu(e,t){return md(e,j(n=>S(t?_u:"web_app_exit_fullscreen",[Cr,"fullscreen_failed"],n).then(o=>{if("error"in o&&o.error!=="ALREADY_FULLSCREEN")throw new bs(o.error);const s="is_fullscreen"in o?o.is_fullscreen:!0;s!==Gr()&&Se({isFullscreen:s})}),"Fullscreen mode change is already being requested",{promise:_d,error:hd})[0])}const yu=gu("requestFullscreen",!0),vu=gu("exitFullscreen"),bd=Object.freeze(Object.defineProperty({__proto__:null,bindCssVars:fu,changeFullscreenError:bu,changeFullscreenPromise:hu,contentSafeAreaInsetBottom:qr,contentSafeAreaInsetLeft:Ir,contentSafeAreaInsetRight:jr,contentSafeAreaInsetTop:Dr,contentSafeAreaInsets:Dt,exitFullscreen:vu,expand:mu,height:qt,isCssVarsBound:du,isExpanded:Xc,isFullscreen:Gr,isMounted:lu,isMounting:cu,isStable:xc,mount:au,mountError:uu,mountPromise:Ur,requestFullscreen:yu,safeAreaInsetBottom:Nr,safeAreaInsetLeft:Vr,safeAreaInsetRight:Lr,safeAreaInsetTop:Rr,safeAreaInsets:Vt,stableHeight:It,state:Br,unmount:pu,width:Or},Symbol.toStringTag,{value:"Module"})),wu="web_app_request_emoji_status_access",[gd,yd,vd]=j(e=>S(wu,"emoji_status_access_requested",e).then(t=>t.status),"Emoji status access request is already in progress"),wd=E("requestEmojiStatusAccess",gd,{isSupported:wu}),[,Ed,Sd]=yd,[,$d]=vd,Eu="web_app_set_emoji_status",[Cd,Ad,Md]=j((e,t)=>S(Eu,["emoji_status_set","emoji_status_failed"],{params:{custom_emoji_id:e,duration:(t||{}).duration},...t}).then(n=>{if(n&&"error"in n)throw new hs(n.error)}),"Emoji status set request is currently in progress"),kd=E("setEmojiStatus",Cd,{isSupported:Eu}),[,Pd,Td]=Ad,[,Bd]=Md,Od={isSupported:"web_app_add_to_home_screen"},Su="home_screen_failed",qd=E("onAddToHomeScreenFailed",(e,t)=>w(Su,e,t),{isSupported:"web_app_add_to_home_screen"}),Id=E("offAddToHomeScreenFailed",e=>{B(Su,e)},Od),$u={isSupported:"web_app_add_to_home_screen"},Cu="home_screen_added",jd=E("onAddedToHomeScreen",(e,t)=>w(Cu,e,t),$u),Dd=E("offAddedToHomeScreen",e=>{B(Cu,e)},$u),Au="web_app_add_to_home_screen",Nd=E("addToHomeScreen",()=>{f(Au)},{isSupported:Au}),Mu="web_app_check_home_screen",[Vd,Ld,Rd]=j(e=>S(Mu,"home_screen_checked",e).then(t=>t.status||"unknown"),"Check home screen status request is currently in progress"),Hd=E("checkHomeScreenStatus",Vd,{isSupported:Mu}),[,Fd,Ud]=Ld,[,Wd]=Rd,zd=re()("openLink",(e,t)=>{if(typeof e=="string")try{e=new URL(e)}catch(n){throw new U(`"${e.toString()}" is invalid URL`,n)}t||(t={}),f("web_app_open_link",{url:e.toString(),try_browser:t.tryBrowser,try_instant_view:t.tryInstantView})}),ku="web_app_open_tg_link",Pu=re()("openTelegramLink",e=>{const t=e.toString();if(!t.match(/^https:\/\/t.me\/.+/))throw new U(`"${t}" is invalid URL`);if(!ee(ku,te())){window.location.href=t;return}e=new URL(e),f(ku,{path_full:e.pathname+e.search})}),Gd=re()("shareURL",(e,t)=>{Pu("https://t.me/share/url?"+new URLSearchParams({url:e,text:t||""}).toString().replace(/\+/g,"%20"))});function Qd(e,t){return new C({abortSignal:t,timeout:e}).catch(()=>{})}const Tu="web_app_request_phone",[Kd,Jd,Yd]=j(e=>S(Tu,"phone_requested",e).then(t=>t.status),"Phone access request is currently in progress"),Bu=E("requestPhoneAccess",Kd,{isSupported:Tu}),[,Zd,Xd]=Jd,[,xd]=Yd,Ou={isSupported:"web_app_request_phone"};async function qu(e){const t=Y($(),await ie("getRequestedContact",{},{...e,timeout:(e||{}).timeout||5e3}));return{raw:t,parsed:Y(_e(ro([$(),eo(URLSearchParams)]),on(D({contact:_e($(),Ke(),D({user_id:Ae(),phone_number:$(),first_name:$(),last_name:ze($())})),auth_date:_e($(),zt(n=>new Date(Number(n)*1e3)),Kt()),hash:$()}))),t)}}const[ef,tf,nf]=j(e=>new C(async(t,n,o)=>{try{return t(await qu(o))}catch(a){if(a instanceof Wt)throw a}if(await Bu(o)!=="sent")throw new gn("User denied access");let i=50;for(;!o.isAborted();){try{return t(await qu(o))}catch(a){if(a instanceof Wt)throw a}await Qd(i),i+=50}},e),"Contact is already being requested"),Iu=E("requestContactComplete",ef,Ou),rf=E("requestContact",e=>Iu(e).then(t=>t.parsed),Ou),[,of,sf]=tf,[,af]=nf,ju="web_app_request_write_access",[cf,uf,lf]=j(e=>S(ju,"write_access_requested",e).then(t=>t.status),"Write access request is currently in progress"),pf=E("requestWriteAccess",cf,{isSupported:ju}),[,df,ff]=uf,[,mf]=lf;function _f(e){const t=document.createElement("textarea");t.value=e,t.style.top="0",t.style.left="0",t.style.position="fixed",document.body.appendChild(t),t.focus(),t.select();try{document.execCommand("copy")}finally{document.body.removeChild(t)}}async function hf(e){try{const{clipboard:t}=navigator;if(t)return await t.writeText(e)}catch{}_f(e)}const Du="web_app_request_file_download",bf=E("downloadFile",(e,t,n)=>S(Du,"file_download_requested",{...n,params:{url:e,file_name:t}}).then(o=>{if(o.status!=="downloading")throw new gn("User denied the action")}),{isSupported:Du}),gf=E("getCurrentTime",e=>ie("getCurrentTime",{},e).then(t=>Y(_e(Ae(),Zr(),zt(n=>new Date(n*1e3)),Kt()),t)),{isSupported:"web_app_invoke_custom_method"}),Nu="web_app_read_text_from_clipboard",yf=E("readTextFromClipboard",e=>{const t=hn();return S(Nu,"clipboard_text_received",{...e,params:{req_id:t},capture:cs(t)}).then(({data:n=null})=>n)},{isSupported:Nu});function Vu(e){const t={},n=e.match(/Telegram-Android(?:\/([^ ]+))?(?: (\([^)]+\))?|$)/);if(n){const[,o,s]=n;o&&(t.appVersion=o),s&&s.slice(1,s.length-1).split(";").forEach(i=>{const[a,c]=i.trim().split(" ");if(a==="Android")t.androidVersion=c;else if(a==="SDK"){const u=parseInt(c,10);u&&(t.sdkVersion=u)}else c?(t.manufacturer=a,t.model=c):t.performanceClass=a})}return t}function vf(){return Vu(navigator.userAgent)}const Lu="web_app_data_send",wf=E("sendData",e=>{const{size:t}=new Blob([e]);if(!t||t>4096)throw new U(t?"Maximum size of data to send is 4096 bytes":"Attempted to send empty data");f(Lu,{data:e})},{isSupported:Lu}),Ru="web_app_send_prepared_message",Ef=E("shareMessage",(e,t)=>S(Ru,["prepared_message_failed","prepared_message_sent"],{...t,params:{id:e}}).then(n=>{if(n&&"error"in n)throw new gs(n.error)}),{isSupported:Ru}),Hu="web_app_share_to_story",Sf=E("shareStory",(e,t)=>{t||(t={}),f(Hu,{text:t.text,media_url:e,widget_link:t.widgetLink})},{isSupported:Hu}),$f="web_app_switch_inline_query",Cf=E("switchInlineQuery",(e,t)=>{f($f,{query:e,chat_types:t||[]})},{isSupported(){return Be().tgWebAppBotInline?void 0:"The application must be launched in the inline mode"}});function Af(e){try{return[!0,e()]}catch(t){return[!1,t]}}function Mf(e){ms(e);const[t,n]=Ge(w("reload_iframe",()=>{xe().log("Received a request to reload the page"),f("iframe_will_reload"),window.location.reload()})),{acceptCustomStyles:o=!0}=e||{};if(o){const s=document.createElement("style");s.id="telegram-custom-styles",document.head.appendChild(s),t(w("set_custom_style",i=>{s.innerHTML=i}),()=>{document.head.removeChild(s)})}return f("iframe_ready",{reload_supported:!0}),xe().log("The package was initialized"),n}return r.AbortablePromise=C,r.AccessDeniedError=gn,r.CSSVarsBoundError=et,r.CancelledError=io,r.ConcurrentCallError=_s,r.FullscreenFailedError=bs,r.FunctionUnavailableError=ve,r.InvalidArgumentsError=U,r.InvalidEnvError=Ql,r.InvalidLaunchParamsError=es,r.InvokeCustomMethodError=ns,r.LaunchParamsRetrieveError=xo,r.ManualPromise=mo,r.MethodParameterUnsupportedError=Xo,r.MethodUnsupportedError=Zo,r.NotAvailableError=bn,r.SetEmojiStatusError=hs,r.ShareMessageError=gs,r.TimeoutError=co,r.UnknownEnvError=ts,r.UnknownThemeParamsKeyError=tt,r.addToHomeScreen=Nd,r.applyPolyfills=Fl,r.authenticateBiometry=Ws,r.backButton=rp,r.bindMiniAppCssVars=Ha,r.bindThemeParamsCssVars=$a,r.bindViewportCssVars=fu,r.biometry=mp,r.biometryAuthError=Gs,r.biometryAuthPromise=kn,r.biometryMountError=Fs,r.biometryState=Bs,r.bridgeLogger=x,r.changeFullscreenError=bu,r.changeFullscreenPromise=hu,r.checkHomeScreenStatus=Hd,r.checkHomeScreenStatusError=Wd,r.checkHomeScreenStatusPromise=Fd,r.closeMiniApp=Fa,r.closeQrScanner=lc,r.closingBehavior=hp,r.cloudStorage=yp,r.configure=ms,r.copyTextToClipboard=hf,r.createLogger=Xt,r.createPostEvent=ls,r.createRequestId=hn,r.createStartParam=Vl,r.decodeBase64Url=Uo,r.decodeStartParam=Ll,r.deleteCloudStorageItem=qn,r.disableClosingConfirmation=ni,r.disableVerticalSwipes=Gc,r.downloadFile=bf,r.emitEvent=Ye,r.enableClosingConfirmation=ri,r.enableVerticalSwipes=Qc,r.encodeBase64Url=un,r.exitFullscreen=vu,r.expandViewport=mu,r.getCloudStorageItem=ci,r.getCloudStorageKeys=In,r.getCurrentTime=gf,r.hapticFeedback=vp,r.hapticFeedbackImpactOccurred=pi,r.hapticFeedbackNotificationOccurred=di,r.hapticFeedbackSelectionChanged=fi,r.hideBackButton=Cs,r.hideSettingsButton=Dc,r.ignoreCanceled=Sn,r.init=Mf,r.initData=Ep,r.initDataAuthDate=Dn,r.initDataCanSendAfter=Nn,r.initDataCanSendAfterDate=hi,r.initDataChat=bi,r.initDataChatInstance=yi,r.initDataChatType=gi,r.initDataHash=vi,r.initDataQueryId=wi,r.initDataRaw=Ei,r.initDataReceiver=Si,r.initDataStartParam=Ci,r.initDataState=_i,r.initDataUser=Ai,r.invoice=kp,r.invokeCustomMethod=ie,r.isAccessDeniedError=xl,r.isAuthenticatingBiometry=zs,r.isBackButtonMounted=Es,r.isBackButtonSupported=Ss,r.isBackButtonVisible=ws,r.isBiometryAvailable=Os,r.isBiometryMounted=Us,r.isBiometryMounting=Hs,r.isBiometrySupported=Ns,r.isCSSVarsBoundError=zl,r.isCancelledError=ao,r.isCheckingHomeScreenStatus=Ud,r.isClosingBehaviorMounted=Bn,r.isClosingConfirmationEnabled=ei,r.isCloudStorageSupported=ai,r.isColorDark=Un,r.isConcurrentCallError=Zl,r.isFullscreen=Gr,r.isFullscreenFailedError=ep,r.isFunctionNotAvailableError=Jl,r.isHapticFeedbackSupported=li,r.isInvalidArguments=Yl,r.isInvalidEnvError=Kl,r.isInvalidLaunchParamsError=ql,r.isInvoiceOpened=Ti,r.isInvoiceSupported=Mi,r.isInvokeCustomMethodError=jl,r.isLaunchParamsRetrieveError=Ol,r.isLocationManagerAccessGranted=ji,r.isLocationManagerAccessRequested=Di,r.isLocationManagerAvailable=Ii,r.isLocationManagerMounted=Ui,r.isLocationManagerMounting=Hi,r.isLocationManagerSupported=qi,r.isMainButtonEnabled=la,r.isMainButtonLoaderVisible=pa,r.isMainButtonMounted=Jn,r.isMainButtonVisible=da,r.isMethodMethodParameterUnsupportedError=Bl,r.isMethodUnsupportedError=Tl,r.isMiniAppActive=ja,r.isMiniAppCssVarsBound=qa,r.isMiniAppDark=Ia,r.isMiniAppMounted=Ga,r.isMiniAppMounting=Wa,r.isMiniAppSupported=Da,r.isNotAvailableError=Gl,r.isPopupOpened=nc,r.isPopupShown=ic,r.isPopupSupported=Za,r.isQrScannerOpened=fc,r.isQrScannerSupported=pc,r.isRGB=se,r.isRGBShort=qo,r.isRequestingBiometryAccess=Js,r.isRequestingContact=sf,r.isRequestingEmojiStatusAccess=Sd,r.isRequestingLocation=zi,r.isRequestingPhoneAccess=Xd,r.isRequestingWriteAccess=ff,r.isSSR=yn,r.isSafeToCreateStartParam=Rl,r.isSecondaryButtonEnabled=bc,r.isSecondaryButtonLoaderVisible=gc,r.isSecondaryButtonMounted=yr,r.isSecondaryButtonSupported=$c,r.isSecondaryButtonVisible=yc,r.isSetEmojiStatusError=Xl,r.isSettingEmojiStatus=Td,r.isSettingsButtonMounted=qc,r.isSettingsButtonSupported=Ic,r.isSettingsButtonVisible=Oc,r.isShareMessageError=tp,r.isSwipeBehaviorMounted=Fc,r.isSwipeBehaviorSupported=Uc,r.isTMA=mn,r.isThemeParamsCssVarsBound=Ji,r.isThemeParamsDark=ta,r.isThemeParamsMounted=Ma,r.isThemeParamsMounting=Ca,r.isTimeoutError=el,r.isUnknownEnvError=Il,r.isUnknownThemeParamsKeyError=np,r.isVerticalSwipesEnabled=Wc,r.isViewportCssVarsBound=du,r.isViewportExpanded=Xc,r.isViewportMounted=lu,r.isViewportMounting=cu,r.isViewportStable=xc,r.locationManager=Vp,r.locationManagerMountError=Fi,r.locationManagerMountPromise=Ri,r.mainButton=Hp,r.mainButtonBackgroundColor=ca,r.mainButtonHasShineEffect=ua,r.mainButtonState=dt,r.mainButtonText=fa,r.mainButtonTextColor=ma,r.miniApp=Qp,r.miniAppBackgroundColor=Ta,r.miniAppBackgroundColorRGB=_t,r.miniAppBottomBarColor=Ba,r.miniAppBottomBarColorRGB=ht,r.miniAppHeaderColor=Oa,r.miniAppHeaderColorRGB=sr,r.miniAppMountError=za,r.miniAppMountPromise=dr,r.miniAppReady=Ka,r.miniAppState=ar,r.mockTelegramEnv=Dl,r.mountBackButton=As,r.mountBiometry=Rs,r.mountBiometryPromise=Mn,r.mountClosingBehavior=oi,r.mountLocationManager=Li,r.mountMainButton=ha,r.mountMiniApp=Ua,r.mountMiniAppSync=Qa,r.mountSecondaryButton=Cc,r.mountSettingsButton=Nc,r.mountSwipeBehavior=Kc,r.mountThemeParams=tr,r.mountThemeParamsSync=or,r.mountViewport=au,r.off=B,r.offAddToHomeScreenFailed=Id,r.offAddedToHomeScreen=Dd,r.offBackButtonClick=ks,r.offMainButtonClick=ga,r.offSecondaryButtonClick=Mc,r.offSettingsButtonClick=Lc,r.on=w,r.onAddToHomeScreenFailed=qd,r.onAddedToHomeScreen=jd,r.onBackButtonClick=Ms,r.onMainButtonClick=ba,r.onSecondaryButtonClick=Ac,r.onSettingsButtonClick=Vc,r.openBiometrySettings=Qs,r.openInvoice=ki,r.openInvoiceError=Bi,r.openInvoicePromise=Pi,r.openLink=zd,r.openLocationManagerSettings=Qi,r.openPopup=ec,r.openPopupError=rc,r.openPopupPromise=tc,r.openQrScanner=dc,r.openQrScannerError=mc,r.openQrScannerPromise=br,r.openTelegramLink=Pu,r.parseInitDataQuery=gl,r.parseLaunchParamsQuery=Je,r.popup=Jp,r.postEvent=f,r.postMessage=rs,r.postMessageImplementation=Te,r.qrScanner=nd,r.readTextFromClipboard=yf,r.request=S,r.requestBiometry=Is,r.requestBiometryAccess=Ks,r.requestBiometryAccessError=Ys,r.requestBiometryAccessPromise=Pn,r.requestContact=rf,r.requestContactComplete=Iu,r.requestContactError=af,r.requestContactPromise=of,r.requestContentSafeAreaInsets=Hr,r.requestEmojiStatusAccess=wd,r.requestEmojiStatusAccessError=$d,r.requestEmojiStatusAccessPromise=Ed,r.requestFullscreen=yu,r.requestLocation=Wi,r.requestLocationError=Gi,r.requestLocationPromise=Hn,r.requestPhoneAccess=Bu,r.requestPhoneAccessError=xd,r.requestPhoneAccessPromise=Zd,r.requestSafeAreaInsets=Fr,r.requestViewport=nu,r.requestWriteAccess=pf,r.requestWriteAccessError=mf,r.requestWriteAccessPromise=df,r.restoreInitData=$i,r.retrieveAndroidDeviceData=vf,r.retrieveAndroidDeviceDataFrom=Vu,r.retrieveLaunchParams=Xe,r.retrieveRawInitData=as,r.retrieveRawLaunchParams=fn,r.safeCall=Af,r.sdkLogger=xe,r.secondaryButton=od,r.secondaryButtonBackgroundColor=_c,r.secondaryButtonHasShineEffect=hc,r.secondaryButtonPosition=vc,r.secondaryButtonState=Ct,r.secondaryButtonText=wc,r.secondaryButtonTextColor=Ec,r.sendData=wf,r.serializeInitDataQuery=Lo,r.serializeLaunchParamsQuery=Ro,r.serializeToQuery=an,r.setCloudStorageItem=ui,r.setDebug=Wl,r.setEmojiStatus=kd,r.setEmojiStatusError=Bd,r.setEmojiStatusPromise=Pd,r.setMainButtonParams=ya,r.setMiniAppBackgroundColor=Et,r.setMiniAppBottomBarColor=St,r.setMiniAppHeaderColor=$t,r.setSecondaryButtonParams=kc,r.settingsButton=sd,r.shareMessage=Ef,r.shareStory=Sf,r.shareURL=Gd,r.showBackButton=Ps,r.showPopup=oc,r.showPopupError=ac,r.showPopupPromise=sc,r.showSettingsButton=Rc,r.supports=ee,r.swipeBehavior=ad,r.switchInlineQuery=Cf,r.targetOrigin=os,r.themeParams=Wp,r.themeParamsAccentTextColor=Yi,r.themeParamsBackgroundColor=zn,r.themeParamsBottomBarBgColor=Zi,r.themeParamsButtonColor=pt,r.themeParamsButtonTextColor=Gn,r.themeParamsDestructiveTextColor=Xi,r.themeParamsHeaderBackgroundColor=xi,r.themeParamsHintColor=ea,r.themeParamsLinkColor=na,r.themeParamsMountError=Aa,r.themeParamsMountPromise=nr,r.themeParamsSecondaryBackgroundColor=Qn,r.themeParamsSectionBackgroundColor=ra,r.themeParamsSectionHeaderTextColor=oa,r.themeParamsSectionSeparatorColor=sa,r.themeParamsState=ue,r.themeParamsSubtitleTextColor=ia,r.themeParamsTextColor=aa,r.toRGB=Io,r.transformQueryUsing=on,r.unmountBackButton=Ts,r.unmountBiometry=Zs,r.unmountClosingBehavior=si,r.unmountLocationManager=Ki,r.unmountMainButton=va,r.unmountMiniApp=Ja,r.unmountSecondaryButton=Pc,r.unmountSettingsButton=Hc,r.unmountSwipeBehavior=Jc,r.unmountThemeParams=ka,r.unmountViewport=pu,r.updateBiometryToken=Xs,r.viewport=bd,r.viewportContentSafeAreaInsetBottom=qr,r.viewportContentSafeAreaInsetLeft=Ir,r.viewportContentSafeAreaInsetRight=jr,r.viewportContentSafeAreaInsetTop=Dr,r.viewportContentSafeAreaInsets=Dt,r.viewportHeight=qt,r.viewportMountError=uu,r.viewportMountPromise=Ur,r.viewportSafeAreaInsetBottom=Nr,r.viewportSafeAreaInsetLeft=Vr,r.viewportSafeAreaInsetRight=Lr,r.viewportSafeAreaInsetTop=Rr,r.viewportSafeAreaInsets=Vt,r.viewportStableHeight=It,r.viewportState=Br,r.viewportWidth=Or,r.wrapSafe=E,Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}),r}({});
